...
public class MincepieEntity extends HostileEntity {
    public MincepieEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createMincepieAttributeBuilder() {
