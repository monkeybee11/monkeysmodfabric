...
public class CoconutEntity extends HostileEntity {

    public CoconutEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createCoconutAttributeBuilder() {
