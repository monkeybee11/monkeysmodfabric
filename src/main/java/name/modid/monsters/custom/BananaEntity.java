...
public class BananaEntity extends HostileEntity {
    public BananaEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createBananaAttributeBuilder() {
