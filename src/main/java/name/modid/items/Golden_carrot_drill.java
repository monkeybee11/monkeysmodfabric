...
public class Golden_carrot_drill extends PickaxeItem {

    public Golden_carrot_drill(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
